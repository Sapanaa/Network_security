...
from network_security.utils.ml_utils.metric.classification_metric import get_classification_metric_score
...
class ModelTrainer:
    ...
    def train_model(self, X_train, y_train, X_test, y_test):
        ...
        model_report: dict = evaluate_models(X_train= X_train, y_train= y_train, X_test= X_test, y_test= y_test, models =models, params=params_grid)
        ...
        classification_train_metric = get_classification_metric_score(y_train, best_model.predict(X_train))


        y_test_pred = best_model.predict(X_test)
        classification_test_metric = get_classification_metric_score(y_test, y_test_pred)
